 ...
 * - la couleur du fond, c'est a dire du cadre derriere le texte (via setBackground)
...
public class PanelImagesAvecDefilement extends JPanel {
	...
	/** Étiquette qui contient l'image **/
	private JLabel lblPourContenirImage;
	/** Nombre de pages **/
	private int nombrePages;
	/** Page à la quelle l'utilisateur est rendue */
	private int pageCourante=0;
	/** Tableau contenant les images des pages **/
	private String[] tableauImages;
	/** Boolean qui définit si oui ou non le resize est récessaire **/
