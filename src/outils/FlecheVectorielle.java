...
public class FlecheVectorielle implements Dessinable {
	...
	/** coordonnées d'origine de la flèche */
	private double x1, y1;
	/** coordonnées de fin de la flèche */
	private double x2, y2;
	/** tracés du corps et de la tête de la flèche */
	private Line2D.Double corps, traitDeTete;
	/** angle entre les deux tracés formant la tête de la flèche (°) */
	private double angleTete = 30;
	/** longueur des tracés formant la tête de flèche */
	private double longueurTraitDeTete = 1;
	/** pixels par mètre (px/m) */
